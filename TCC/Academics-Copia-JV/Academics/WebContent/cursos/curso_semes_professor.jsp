...
<body>
	...
	<%
		ArrayList<DisciplinaDTO> disciplinas = (ArrayList) disciplinaVO.getDisciplinas();
		...
		if(request.getAttribute("disciplinaSelecionada") == null)
			request.setAttribute("disciplinaSelecionada", "0");
	...
	%>	
		...
		<label> Disciplina:</label><BR>
			 <select name="disciplina" class="form-control">
				...
				%>
						<option value= <%=disciplinas.get(i).getCodigo()%>> <%=disciplinas.get(i).getNome()%></option>
				<%
					}
				%>
			</select> <br> <br>
