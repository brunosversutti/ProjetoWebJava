...
<body>
	...
	<div class="container">
		...
		<h2>Vincular Professor ao Semestre</h2>
	...
	%>	
		...
		<form class="col-md-5 col-md-offset-4" name="frmaluno" action="../Servlets/ServletProfSemestre" method="post" onsubmit="VerificaCPF();">
